...
class WFOVCompressedImage {
  ...
  static serialize(obj, bufferInfo) {
    ...
    bufferInfo = sensor_msgs.msg.CompressedImage.serialize(obj.image, bufferInfo);
    ...
    bufferInfo = geometry_msgs.msg.TransformStamped.serialize(obj.worldToCamera, bufferInfo);
    return bufferInfo;
  }
  ...
  static deserialize(buffer) {
    ...
    let tmp;
    let len;
    let data = new WFOVCompressedImage();
    ...
    tmp = sensor_msgs.msg.CompressedImage.deserialize(buffer);
    data.image = tmp.data;
    buffer = tmp.buffer;
